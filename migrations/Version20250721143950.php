 ...
 */
final class Version20250721143950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipe (id_equipe INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, pays VARCHAR(100) NOT NULL, nom_capitaine VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, telephone VARCHAR(20) NOT NULL, date_creation DATETIME NOT NULL, PRIMARY KEY(id_equipe)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
